...
function toggleProjectsView() {
  if (futureProjsRadio.checked) {
    // Show future message, hide past projects and filters
    container.style.display = "none";
    comContainer.style.display = "none";
    futureMessage.style.display = "flex";
  } else {
    // Show past projects and filters, hide future message
...
const FAQData = [
  ...
  },
  {
    ...
    answer: [
      ...
      "If you continue as a masters student (like our SAA) or med (like our secretary), you can stay as a member in the university club.",
    ],
  },
  {
    question: "What does rotaract mean?",
    answer: [
      "A Rotaract club is Rotary sponsored and have people between the ages 18-30 that want to make an impact in their community while having fun and networking.",
    ],
  },
];
